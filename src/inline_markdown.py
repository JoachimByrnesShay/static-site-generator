...
def text_to_textnodes(text):
    ...
    with_italic_nodes = split_nodes_delimiter(bold_nodes, "_", TextType.ITALIC)
    with_code_nodes = split_nodes_delimiter(with_italic_nodes, "`", TextType.CODE)
    with_images = split_nodes_image(with_code_nodes)
    all_with_links = split_nodes_link(with_images)
